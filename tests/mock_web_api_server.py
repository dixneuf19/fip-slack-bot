# Source: https://github.com/slackapi/bolt-python/blob/main/tests/mock_web_api_server.py
import json
import logging
import threading
...
class MockHandler(SimpleHTTPRequestHandler):
    ...
    received_requests = {}
    received_requests_body = {"/chat.postMessage": []}
...
class MockServerThread(threading.Thread):
    ...
    def run(self):
        ...
        self.test.mock_received_requests_body = self.handler.received_requests_body
